package co.spaceinvaders.entities
{
	...
	public class StandardSpaceInvader extends Entity
	{
		[Embed(source = 'assets/sprites/normalalien.png')]		
		...
		public function StandardSpaceInvader(startingX:Number, startingY:Number)
		{
			...
			collidable = true;
			setHitbox(StandardSpaceInvader.WIDTH * _SpaceInvader.scale, StandardSpaceInvader.HEIGHT* _SpaceInvader.scale);
		}
