package co.spaceinvaders.entities
{
	...
	public class MetroidSpaceInvader extends Entity
	{
		[Embed(source = 'assets/sprites/metroidlikealien.png')]		
		...
		public function MetroidSpaceInvader(startingX:Number, startingY:Number)
		{
			...
			collidable = true;
			setHitbox(MetroidSpaceInvader.WIDTH * _SpaceInvader.scale, MetroidSpaceInvader.HEIGHT* _SpaceInvader.scale);
		}
